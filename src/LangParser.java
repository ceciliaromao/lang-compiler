...
public class LangParser extends Parser {
	...
	public static final int
		...
		T__24=25, TYID=26, ID=27, INT=28, FLOAT=29, CHAR=30, WS=31, COMMENT=32, 
		BLOCK_COMMENT=33;
	public static final int
		RULE_program = 0, RULE_def = 1, RULE_block = 2, RULE_cmd = 3, RULE_expList = 4, 
		RULE_exp = 5;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "def", "block", "cmd", "expList", "exp"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, "TYID", "ID", "INT", "FLOAT", "CHAR", "WS", "COMMENT", "BLOCK_COMMENT"
		};
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 134221120L) != 0)) {
				{
				{
				setState(31);
				cmd();
	...
	public final CmdContext cmd() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2076311568L) != 0)) {
					{
					setState(66);
					expList();
					}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						...
						setState(109);
						((ExpContext)_localctx).op = match(T__20);
						setState(110);
						exp(12);
						}
						break;
